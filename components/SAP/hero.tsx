    ...
    <section className={styles.hero}>
      ...
      <div className='w-full'>
        ...
        <motion.div
          ...
          <motion.a
            className="px-3 py-2 bg-neutral-50 hover:cursor-pointer text-blue-700 hover:bg-yellow-400 hover:text-slate-900 font-medium rounded-full w-full lg:w-max mt-8 lg:mt-0"
