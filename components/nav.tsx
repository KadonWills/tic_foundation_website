...
const NavBar = () => {
    return (
        ...
        <div className="fixed  z-[1000] flex justify-between align-middle w-[98%] top-5 left-1/2 -translate-x-1/2 m-0 px-10  pb-0 bg-slate-800 rounded-lg text-base text-white">
            ...
            <span className='hidden md:grid align-middle text-center min-h-full my-auto'>
                <ul className="flex justify-center text-justify text-sm align-middle space-x-5">
                    ...
                    <li>
                        <button className="px-3 py-1 m-0 align-middle box-border hover:bg-white hover:text-blue-600 bg-blue-600 text-white duration-200 rounded" > Register </button>
                    </li>
