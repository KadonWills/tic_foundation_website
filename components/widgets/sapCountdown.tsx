                    ...
                    <div className="flex items-center flex-col md:flex-row -mx-5">
                        <div className="w-full px-5 mb-5 md:mb-0 text-center md:text-left">
                            ...
                            <div className="mt-4 w-full md:w-44">
                                <a href='https://docs.google.com/forms/d/1m3S9AKbFxEXd2VIdyampszRbF_UNP-7IK8n3JeDipi4' target={'_blank'} className="py-2 px-4  bg-white hover:bg-gray-100 focus:ring-blue-500 focus:ring-offset-blue-200 text-blue-500 hover:bg-blue-500 hover:text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                    Register Now
                                </a>
                            </div>
                        </div>
